...
try:
    def main():
        if len(sys.argv) == 2:
            if sys.argv[1] == "BTLDR_0.6":
                os.system("cls" if sys.platform == "win32" else "clear")
                print("Procyon Neo Kernel v0.6")
                print("..............")
                ...
                if os.path.exists("shell.py"):
                    ...
                    os.system("python3 shell.py KRNL_0.6")
                else:
                    os.system("cls" if sys.platform == "win32" else "clear")
                ...
                print(f" Reported {sys.argv[1]} as opposed to BTLDR_0.6")
...
def callApplication(app, isAdmin = False):
    appResolved = app + ".py KRNL_0.6 " + str(isAdmin)
