...
try:
    def main():
        if len(sys.argv) == 2:
            if sys.argv[1] == "BTLDR_0.5C4":
                os.system("cls" if sys.platform == "win32" else "clear")
                print("Procyon Neo Kernel v0.5C4")
                print("..............")
                ...
                if os.path.exists("shell.py"):
                    ...
                    os.system("python3 shell.py KRNL_0.5C4")
                else:
                    os.system("cls" if sys.platform == "win32" else "clear")
                ...
                print(f" Reported {sys.argv[1]} as opposed to BTLDR_0.5C4")
...
def callApplication(app, isAdmin = False):
    appResolved = app + ".py KRNL_0.5C4 " + str(isAdmin)
