    ...
    def main():
        if len(sys.argv) == 2:
            if sys.argv[1] == "1.1.2":
                ...
                print("Procyon Neo Kernel v1.1.2")
                print("..............")
                ...
                if os.path.exists("shell.py"):
                    ...
                    os.system("python3 shell.py 1.1.2")
                else:
                    os.system("cls" if sys.platform == "win32" else "clear")
                ...
                print(f" Reported {sys.argv[1]} as opposed to 1.1.2")
...
def callApplication(app, isAdmin = False):
    appResolved = "python3 " + app + ".py 1.1.2 " + str(isAdmin)
    os.system(appResolved)

def callApplication3P(app, isAdmin = False):
    appResolved = "python3 apps/" + app + ".py 1.1.2 " + str(isAdmin)
    os.system(appResolved)