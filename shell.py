...
def oobe():
    ...
    kernel.printWarning("Note : AppMarket is under development and not functional in this build. To publish your application, pull request on GitHub.")
    time.sleep(5)
    print()
    input("Press any key to continue...")
    kernel.clrscr()
    ...
    kernel.printWarning("Note: ChatCLS is still in beta, and requires OpenAI API key.")
    time.sleep(5)
    print()
    input("Press any key to continue...")
    kernel.clrscr()
    ...
    kernel.printWarning("Note: NetGet is still in beta, and may not work properly.")
    time.sleep(5)
    print()
    input("Press any key to continue...")
    kernel.clrscr()
...
def main():
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == "0.9M":
            ...
            print("                         0.9M Developer Preview VI")
            ...
            print(f"Expected 0.9M, got {sys.argv[1]}")
            sys.exit(1)
    else:
